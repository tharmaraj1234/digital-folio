...
<body>
        <header>
            <div class="header-content">
               ...
               <img src="THARMARAJ R" alt="your profile picture" class="profile=picture">
               <h1>Tharmaraj</h1>
            ...
            <section id="about">
                <div class="section-content">
                     <h2>About Me</h2>
                     <p>Hello Everyone THARMARAJ and i am a computer science learner.</p>
                </div>
            </section>
